...
import bikefind.casestudy.Ujwal.Pradhan.security.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/pub/**", "/error/**", "/login/**","/search", "/product", "/orderProducts/**", "/createProduct", "/index", "/login/loginSecurityPost").permitAll()
